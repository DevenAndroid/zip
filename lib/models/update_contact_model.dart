class ModelUpdateContact {
  Contact? contact;

  ModelUpdateContact({this.contact});

  ModelUpdateContact.fromJson(Map<String, dynamic> json) {
    contact =
...
class Contact {
  ...
  dynamic openDealsAmount;
  dynamic wonDealsAmount;
  Links? links;
  dynamic lastContactedSalesActivityMode;
  CustomField? customField;
  String? createdAt;
  String? updatedAt;
  dynamic keyword;
  dynamic medium;
  dynamic lastContactedMode;
  dynamic recentNote;
  dynamic wonDealsCount;
  dynamic lastContactedViaSalesActivity;
  dynamic completedSalesSequences;
  dynamic activeSalesSequences;
  dynamic webFormIds;
  dynamic openDealsCount;
  ...
  dynamic unsubscriptionReason;
  dynamic otherUnsubscriptionReason;
  int? customerFit;
  int? whatsappSubscriptionStatus;
  dynamic lastSeenChat;
  dynamic firstSeenChat;
  dynamic locale;
  dynamic totalSessions;
  dynamic firstCampaign;
  dynamic firstMedium;
  dynamic firstSource;
  dynamic lastCampaign;
  dynamic lastMedium;
  dynamic lastSource;
  Null? latestCampaign;
  Null? latestMedium;
