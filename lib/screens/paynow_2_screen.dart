...
class PayNow2 extends StatefulWidget {
  const PayNow2({Key? key}) : super(key: key);

  @override
  State<PayNow2> createState() => _PayNow2State();
}

class _PayNow2State extends State<PayNow2> {
...
var destinationAddress = Get.arguments[1];
var accountHolder = Get.arguments[2];
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CommonTextfield(
                    ...
                    obSecure: false,
                    hintText: destinationAddress.toString(),
