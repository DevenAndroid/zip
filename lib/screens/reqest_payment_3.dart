              ...
              child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                            onTap: () {
                              Share.share("Account Number- ${registorController.fetchAccount.value.data!.accountNumber.toString()}, "+"Bank Name-  ${ registorController.fetchAccount.value.data!.accountInformation!.bankName.toString()}, "+"Name-  ${ registorController.fetchAccount.value.data!.kYCInformation!.firstName.toString()}",subject: registorController.fetchAccount.value.data!.accountNumber.toString(),);
                              },
