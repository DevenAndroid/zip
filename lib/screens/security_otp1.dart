...
class SecurityOtpScreen1 extends StatefulWidget {
  const SecurityOtpScreen1({Key? key}) : super(key: key);

  @override
  State<SecurityOtpScreen1> createState() => _SecurityOtpScreen1State();
}

class _SecurityOtpScreen1State extends State<SecurityOtpScreen1> {
