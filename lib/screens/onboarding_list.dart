...
List<OnBoarding> page1 = [
  ...
  OnBoarding(
      ...
      description:"Moving money has never been easier with our digital wallet."),
  OnBoarding(
      title: "Collect payment\nfrom anyone",
      img: "assets/images/logo3.png",
      description:"Be ready to receive money in matter of minutes with a simple link from the app."),
