                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Card Transfer ",style: GoogleFonts.poppins(
                                color: const Color(0xFF1D1D1D),
                                fontSize: 15,
                                fontWeight: FontWeight.w500)),
                            SizedBox(height: 15,),
                            Row(
                              ...
                              children: [
                                ...
                                Text("Daily ",style: GoogleFonts.poppins(
                                    color: const Color(0xFF9B9797),
                                    fontSize: 14,
                                    fontWeight: FontWeight.w500)),
                                Text("\$333333 ",style: GoogleFonts.poppins(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text("You have  ",style: GoogleFonts.poppins(
                                    color: const Color(0xFF9B9797),
                                    fontSize: 15,
                                    fontWeight: FontWeight.w500)),
                                Text("\$333333 ",style: GoogleFonts.poppins(
