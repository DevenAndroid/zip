      ...
      if (value.status == true) {
        ...
        if (value.data != null) {
          streetController.text =
              (getaddress.value.data!.streetName ?? "").toString();
          additionalController.text =
              (getaddress.value.data!.additional ?? "").toString();
          cityController.text = (getaddress.value.data!.city ?? "").toString();
          countryController.text =
              (getaddress.value.data!.country ?? "").toString();
          houseNoController.text =
              (getaddress.value.data!.houseNumber ?? "").toString();
          postalCodeController.text =
              (getaddress.value.data!.postalCode ?? "").toString();
          stateController.text =
              (getaddress.value.data!.state ?? "").toString();
        }
      } else {
        ...
        body: Obx(() {
          return statusOfGetAddress.value.isSuccess
                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                                onTap: () {
                                  if (formKeyAddressField.currentState!
                                      .validate()) {
                                    updateUserAddress();
                                  }
                                },
              ...
              : statusOfGetAddress.value.isError
                  ? CommonErrorWidget(
                      errorText: getaddress.value.message.toString(),
                      onTap: () {
                        getPersonalAddress();
                      },
                    )
