...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Rx<ModelNotificationUpdate> notificationUpdate =
      ModelNotificationUpdate().obs;
  ...
  updateNotificationSetting() {
    updateNotificationRepo(
      context: context,
      email_notification:
          modalGetSetting.value.data!.emailNotification! ? "1" : "0",
      push_notification:
          modalGetSetting.value.data!.pushNotification! ? "1" : "0",
    ).then((value) {
