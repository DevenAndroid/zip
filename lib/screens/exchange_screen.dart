...
class _ExchangeMoneyState extends State<ExchangeMoney> {
  ...
  void convertUsd() async {
    var convert =  Currency.values.firstWhere((element) => element.name.toString().toLowerCase() ==Get.arguments[0].toString().toLowerCase());
  ...
  Future Conversions() async {
    await conversionRepo(
            ...
            action: "send",
            sourceCurrency: "NGN",
            destinationCurrency: Get.arguments[0],
