...
Future<RequestMoneyMail> requestMailRepo({requested_id,type,amount,phone,email,by_requested_id,generate_link}) async {
  ...
  if (response.statusCode == 200) {
    ...
    print(jsonDecode(response.body));
    return RequestMoneyMail(message: jsonDecode(response.body)["message"], status: false);
  }
  // }  catch (e) {
