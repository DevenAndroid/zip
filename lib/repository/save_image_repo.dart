...
import '../models/model_send_image.dart';
import '../models/modle_update_profile.dart';
import '../resourses/api_constant.dart';
import '../resourses/helper.dart';

Future<ModelSendImage> liveImageRepo({
  required fieldName1,
  required File file1,
  required context,
}) async {
  ...
  try {
    var request = http.MultipartRequest('POST', Uri.parse(ApiUrls.liveImage));
    ...
    if (response.statusCode == 200) {
      ...
      return ModelSendImage.fromJson(
    ...
    Helpers.hideLoader(loader);
    return ModelSendImage(message: "No Internet Access", status: false);
  } catch (e) {
    Helpers.hideLoader(loader);
    return ModelSendImage(message: e.toString(), status: false);
  }
}
