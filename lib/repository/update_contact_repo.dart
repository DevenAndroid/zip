...
Future<ModelUpdateContact> updateContactRepo(
    {mobile_number, cf_customer_id, context, cf_product_type, id}) async {
  ...
  http.Response response = await http.put(
      Uri.parse(
          "https://zipinternationallimited-team.myfreshworks.com/crm/sales/api/contacts/$id"),
      headers: {
      ...
      body: jsonEncode({
        "contact": {
          ...
          "custom_field": {"cf_product_type": cf_product_type}
        }
      }));
  ...
  if (response.statusCode == 200 || response.statusCode == 201) {
    ...
    return ModelUpdateContact.fromJson(
