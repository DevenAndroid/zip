...
Future<ModelApplyLoan> loanRepo({loan_purpose,context,residential_status,employed_status,monthly_income,duration_of_loan,desired_amount,increament}) async {
  ...
  if (response.statusCode == 200) {
    ...
    Helpers.hideLoader(loader);
    print(jsonDecode(response.body));
    return ModelApplyLoan(message: jsonDecode(response.body)["message"], status: false);
  }
  // }  catch (e) {
  //   Helpers.hideLoader(loader);
